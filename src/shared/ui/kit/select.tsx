  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'rounded-md border border-input bg-transparent py-2 pr-2',
        'pl-2.5 text-sm whitespace-nowrap shadow-xs',
        ...
        '*:data-[slot=select-value]:gap-1.5 dark:bg-input/30 dark:hover:bg-input/50',
