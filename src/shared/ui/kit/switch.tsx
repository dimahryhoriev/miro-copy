    ...
    <SwitchPrimitive.Root
      ...
      className={
        cn(
          ...
          'border border-transparent shadow-xs transition-all outline-none after:absolute',
          ...
          'aria-invalid:ring-3 aria-invalid:ring-destructive/20 data-[size=default]:h-[18.4px]',
